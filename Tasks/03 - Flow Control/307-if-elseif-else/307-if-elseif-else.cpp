...
int main()
{
    ...
    if (level <= 5) 
    {
        cout << "Tank has a dangerously low amount of fuel." << endl;
    } 
    else if (level <= 30)                       // check the level
    {
        cout << "Tank has a low amount of fuel." << endl;
    }
    else if (level <= 70) 
    {
        cout << "Tank has a medium amount of fuel" << endl;
    }
    else if (level <= 95)
    {
        cout << "Tank has a high amount of fuel." << endl;
    }
    else {
